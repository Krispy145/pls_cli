...
/// @nodoc
abstract class _$$_ResetPasswordRequestModelCopyWith<$Res>
    implements $ResetPasswordRequestModelCopyWith<$Res> {
  factory _$$_ResetPasswordRequestModelCopyWith(
          _$_ResetPasswordRequestModel value,
          $Res Function(_$_ResetPasswordRequestModel) then) =
      __$$_ResetPasswordRequestModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String email, String password, String token});
}
...
/// @nodoc
class __$$_ResetPasswordRequestModelCopyWithImpl<$Res>
    extends _$ResetPasswordRequestModelCopyWithImpl<$Res,
        _$_ResetPasswordRequestModel>
    implements _$$_ResetPasswordRequestModelCopyWith<$Res> {
  __$$_ResetPasswordRequestModelCopyWithImpl(
      _$_ResetPasswordRequestModel _value,
      $Res Function(_$_ResetPasswordRequestModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_ResetPasswordRequestModel(
      email: null == email
          ? _value.email
          : email // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_ResetPasswordRequestModel implements _ResetPasswordRequestModel {
  const _$_ResetPasswordRequestModel(
      {required this.email, required this.password, required this.token});

  factory _$_ResetPasswordRequestModel.fromJson(Map<String, dynamic> json) =>
      _$$_ResetPasswordRequestModelFromJson(json);
  ...
  @override
  String toString() {
    return 'ResetPasswordRequestModel(email: $email, password: $password, token: $token)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_ResetPasswordRequestModel &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_ResetPasswordRequestModelCopyWith<_$_ResetPasswordRequestModel>
      get copyWith => __$$_ResetPasswordRequestModelCopyWithImpl<
          _$_ResetPasswordRequestModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ResetPasswordRequestModelToJson(
      this,
    );
  }
}
...
abstract class _ResetPasswordRequestModel implements ResetPasswordRequestModel {
  const factory _ResetPasswordRequestModel(
      ...
      required final String token}) = _$_ResetPasswordRequestModel;

  factory _ResetPasswordRequestModel.fromJson(Map<String, dynamic> json) =
      _$_ResetPasswordRequestModel.fromJson;
