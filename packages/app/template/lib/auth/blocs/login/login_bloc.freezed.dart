...
class _$_LoginState extends _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, isLoading: $isLoading, formError: $formError)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, isLoading, formError);
...
abstract class _LoginState extends LoginState {
  const factory _LoginState(
      ...
      final bool isLoading,
      final String? formError}) = _$_LoginState;
