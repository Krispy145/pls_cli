...
class {{name.pascalCase()}}Repository {
  ...
  Future<List<{{name.pascalCase()}}Model?>> getAll{{name.pascalCase()}}ModelsFromApi() {
    return _{{name.camelCase()}}DataRepository.getAll{{name.pascalCase()}}Models(source: SourceTypes.api);
  }
  ...
  Future<void> addAll{{name.pascalCase()}}ModelsFromApi(List<{{name.pascalCase()}}Model> {{name.camelCase()}}Models) {
    return _{{name.camelCase()}}DataRepository.addAll{{name.pascalCase()}}Models(source: SourceTypes.api, {{name.camelCase()}}Models: {{name.camelCase()}}Models);
  }
}
