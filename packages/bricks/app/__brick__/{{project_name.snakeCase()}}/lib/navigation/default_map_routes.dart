...
import 'package:navigation/structures/default_map_shell_structure/widget.dart';
...
class MainShell extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultMapShellStructure(
      store: Managers.defaultMapShellStore,
      appBar: const MainAppBar(),
      map: const Center(
        child: Text('This is a DefaultMap'),
      ),
