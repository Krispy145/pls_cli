...
mixin _$MainStore on MainBaseStore, Store {
  Computed<MainDataSource>? _$dataSourceComputed;

  @override
  MainDataSource get dataSource =>
      (_$dataSourceComputed ??= Computed<MainDataSource>(() => super.dataSource,
              name: 'MainBaseStore.dataSource'))
          .value;
  Computed<MainRepository>? _$repositoryComputed;

  @override
  MainRepository get repository =>
      (_$repositoryComputed ??= Computed<MainRepository>(() => super.repository,
              name: 'MainBaseStore.repository'))
          .value;
